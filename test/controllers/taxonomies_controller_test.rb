...
class TaxonomiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create taxonomy" do
    assert_difference("Taxonomy.count") do
      post taxonomies_url, params: { taxonomy: { description: @taxonomy.description, position: @taxonomy.position, title: @taxonomy.title } }
    end
  ...
  test "should update taxonomy" do
    patch taxonomy_url(@taxonomy), params: { taxonomy: { description: @taxonomy.description, position: @taxonomy.position, title: @taxonomy.title } }
