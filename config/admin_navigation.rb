SimpleNavigation::Configuration.run do |navigation|
  ...
  navigation.items do |primary|
    ...
    primary.item  :reports, Report.model_name.human(count: 2), admin_reports_path, { icon: 'bi bi-question-circle-fill' }
    primary.item  :problems, Problem.model_name.human(count: 2), admin_problems_path, { icon: 'bi bi-exclamation-circle-fill' }
